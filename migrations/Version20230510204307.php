 ...
 */
final class Version20230510204307 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plateforme_produit (plateforme_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_345A217391E226B (plateforme_id), INDEX IDX_345A217F347EFB (produit_id), PRIMARY KEY(plateforme_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
