 ...
 */
final class Version20230510204340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit_plateforme (produit_id INT NOT NULL, plateforme_id INT NOT NULL, INDEX IDX_953A351CF347EFB (produit_id), INDEX IDX_953A351C391E226B (plateforme_id), PRIMARY KEY(produit_id, plateforme_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
